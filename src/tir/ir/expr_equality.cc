...
#define DEFINE_BINOP_VISIT_(OP)						\
    ...
    bool ExprEquality::VisitExpr_(const ReduceNode* op1, const ReduceNode* op2) {
      return VisitArray(op1->axis, op2->axis, [this](const IterVar& r1, const IterVar& r2) {
	  return this->VisitExpr(r1->var, r2->var);
	}) &&
	VisitArray(op1->source, op2->source, [this](const PrimExpr& e1, const PrimExpr& e2) { return this->VisitExpr(e1, e2); }) &&
    ...
    bool ExprEquality::VisitExpr_(const RampNode* op1, const RampNode* op2) {
      return this->VisitExpr(op1->base, op2->base) &&
	this->VisitExpr(op1->stride, op2->stride);
    }

    bool ExprEquality::VisitExpr_(const ShuffleNode* op1, const ShuffleNode* op2) {
      return VisitArray(op1->indices, op2->indices, [this](const PrimExpr& e1, const PrimExpr& e2) { return this->VisitExpr(e1, e2); }) &&
	VisitArray(op1->vectors, op2->vectors, [this](const PrimExpr& e1, const PrimExpr& e2) { return this->VisitExpr(e1, e2); });
    }
