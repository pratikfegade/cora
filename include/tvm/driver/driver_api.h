 ...
 */
TVM_DLL Array<tir::LoweredFunc> lower(te::Schedule sch, const Array<te::Tensor>& args,
...
*/
TVM_DLL Array<Array<tir::LoweredFunc>> split_dev_host_funcs(const Array<tir::LoweredFunc>& funcs,
                                                            const Target& target,
 ...
 */
TVM_DLL runtime::Module build(const Array<tir::LoweredFunc>& funcs, const Target& target,
