...
class Schedule(Object):
    ...
    def rfactor(self, tensor, axis, factor_axis=0, factor_index_pos=0, rfactor_dim = None):
        ...
        """
        factored = _ffi_api.ScheduleRFactor(self, tensor, axis, factor_axis, factor_index_pos, rfactor_dim)
